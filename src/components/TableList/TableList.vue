    ...
    getTableList() {
     ...
     AddTableBtn: function () {
        ...
        lastTableColor () {
             ...
             console.log('linear-gradient( to bottom, ' + 
             colOne + ', ' + colTwo);
     ...
     addTable: function() {
        axios.put(this.endpoint, this.tables ).then(response => {})
            .catch(error => {
                console.log('-----error-----');
                console.log(error);
            }
               ...
               // console.log('Получили id последнего цвета ', lastColId);
                //console.log(this.gradients);
                let id = this.getTableBtnId();
                this.tables.push({
                     "BtnId": id,
    ...
    getTableBtnId: function() {
            ...
            getColId: function() {
              ...
              // let lastId = this.gradients[lastEl].colId;
               ...
               if(lastTableId >= this.gradients.length || typeof(lastTableId) == "undefined") {
                 //ставим 0 исходя из того, что добавим 1 в return
                 lastTableId = 0;
               }
            ...
            delTable: function() {
               ...
               console.log('Массив до удаления ', this.tables);
                ...
                console.log('Массив после удаления ', this.tables, ' Удаленные строки ', spliceRes);
                this.addTable();
            },
                ifLastBtn (Index) {
